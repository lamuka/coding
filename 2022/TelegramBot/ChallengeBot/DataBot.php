...
if(file_exists(''.dirname(__FILE__).'/php_log.txt')==FALSE)
{
	touch(''.dirname(__FILE__).'/php_log.txt');
}

ini_set("error_log", ''.dirname(__FILE__).'/php_log.txt');
...
class DataBot extends TelegramBot
{
	...
	const ADMINUSERNAMES = "xxxxxxxxxxxxxxx";
